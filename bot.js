...
.setThumbnail("https://cdn1.iconfinder.com/data/icons/social-messaging-ui-color-shapes/128/world-circle-blue-128.png")    
      ...
      .addField("**قائمه. **","** لـ عرض صوره لالوان **")
      .addField("**لون. **","** لـ لتغير لونك في السيرفر **")
...
.setThumbnail("https://cdn2.iconfinder.com/data/icons/clean-and-simple/153/Settings-128.png")    
      ...
      .addField("**Member تم عمل اعطاء رتبه بالامر  **","** **")
      .addField("welcome  الترحيب بس لازم وجود شات اسمه")
...
.setThumbnail("https://cdn3.iconfinder.com/data/icons/forall/110/game-128.png")    
      .addField("** :video_game: ااوامر الالعاب**","** **")
...
.setThumbnail("https://cdn2.iconfinder.com/data/icons/circle-icons-1/64/support-128.png") 
	 ...
	 .addField("**موقع البوت للدعم**","**bit.ly/2G4ifil**")
	 .addField("**موقع دعوة البوت**","**bit.ly/2IfdByL**")
      .addField("** مبرمجين البوت :wrench: **","** KiNG | Spyro | Abady | FoxMCAdmin **")
      .addField("**شكرا خاص لمن اضاف البوت :heart: :heart: **","** **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
if (message.content === '.invite') {
      message.author.send(' رابط موقع البوت | bit.ly/2G4ifil').catch(e => console.log(e.stack));
...
client.on('message', message => {
  if (message.content === noncolor) {
 message.reply("**أختر لون** \n ولأظهار الألوان" + "**.قائمة**")
  }
...
if (message.content === ".قائمه") {
	const embed = new Discord.RichEmbed()
	.setColor('RANDOM')
	.setFooter(':] | Color', 'http://www.freeiconspng.com/uploads/color-icon-png-13.png')
	.setDescription(`Type: .لون رقم اللون يلي تبيه`)
	.setImage('https://cdn.discordapp.com/attachments/421383870940708876/421616345478594560/colors.png')
	message.channel.sendEmbed(embed);
	message.react("??")
	}
});
